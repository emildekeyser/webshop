...
public class Person
{
    ...
    public Person(String userid, String email, String password, String firstName, String lastName, AuthorizationRole role)
    {
        setUserid(userid);
        setEmail(email);
    ...
    {
        this(userid, email, password, firstName, lastName, AuthorizationRole.Customer);
    }
